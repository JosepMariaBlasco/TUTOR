...
Here is the [documentation for the stream BIFs](https://rexx.epbcn.com/tutor/doc/packages/Stream.cls.html).
...
### To the ``rxu`` [Rexx Preprocessor for Unicode](https://rexx.epbcn.com/tutor/doc/packages/rxu.rex.html)
...
### To the main Unicode class, [Unicode.cls](https://rexx.epbcn.com/tutor/doc/packages/Unicode.cls.html)

* Rename P2U to C2U, and create a new U2C BIF. Complete symmetry with C2X, X2C and DATATYPE("X").

### Encoding support

A new ``encoding`` subdirectory has been created. The main encoding class is [``Encoding.cls``](https://rexx.epbcn.com/tutor/doc/packages/Encoding.cls.html). Concrete encodings
