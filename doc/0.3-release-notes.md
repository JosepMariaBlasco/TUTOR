...
### To the ``rxu`` [Rexx Preprocessor for Unicode](https://rexx.epbcn.com/tutor/rxu.rex)
...
### To the main Unicode class, [Unicode.cls](https://rexx.epbcn.com/tutor/Unicode.cls)
...
[``Encoding.cls``](https://rexx.epbcn.com/tutor/components/Encoding.cls). Concrete encodings
