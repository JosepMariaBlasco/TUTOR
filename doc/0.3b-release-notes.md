...
* A new ENCODE BIF.
* A new OPTIONS DEFAULTSTRING NONE. Use it when other forms of OPTIONS DEFAULTSTRING causes problems (see
  [the documentation for the RXU preprocessor](https://rexx.epbcn.com/TUTOR/bin/rxu.rex) for details).
